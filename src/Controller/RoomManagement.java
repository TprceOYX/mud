...
public class RoomManagement {
	...
	public static void creatRooms() {
		...
		room_beidajie2.setDescription("你走在一条繁忙的街道上，东边是扬州驿站，来自京城的快马有时会急驶而入，片刻后又会有另一匹快马从里面冲出来绝尘而去，西边是一家大店铺，门前的绣金旗子上写着一个斗大的“当”字，仔细倾听，可以听到压低的讨价还价的声音。");
